...
public class see_all_member extends AppCompatActivity
{
    ListView list;
    Toolbar toolbar;
    @Override
    ...
    private void set_value_in_list()
    {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    show_person_information.get_name(name);
                    try
                    {
                        Intent page = new Intent(see_all_member.this,show_person_information.class);
                        startActivity(page);
                    }catch (Exception e)
                    {
                        e.printStackTrace();
